...
class FirstProductPage(BasePage):
    ...
    # ==========================================================================
    # REUSABLE HELPER METHODS (used by multiple test flows)
    # ==========================================================================
    ...
    def verify_the_add_basket_button(self):
        ...
        Author        : Saptarshi
        Description   : Verifies the 'Add to Basket' button is visible on the product page
        Return Type   : None
        Parameters    : None
        """
        self.perform_action("VERIFY_VISIBLE", FirstProductPageLocators.add_to_basket_button, "Add to Basket Button")

    def click_add_to_basket(self):
        """
        Method Name   : click_add_to_basket
        Author        : Saptarshi, Gitika
        Description   : Clicks on the 'Add to Basket' button
        Return Type   : None
        Parameters    : None
        """
    ...
    def click_check_out(self):
        ...
        Author        : Saptarshi
        Description   : Scrolls to and clicks on the 'Checkout' button
        Return Type   : None
        Parameters    : None
        """
        self.perform_action("SCROLL_AND_CLICK", FirstProductPageLocators.checkout_button, "Checkout")

    def verify_cart_page(self):
        """
        Method Name   : verify_cart_page
        Author        : Saptarshi
        Description   : Verifies the user has landed on the 'My Basket' cart page
        Return Type   : None
        Parameters    : None
        """
        self.perform_action("VERIFY_VISIBLE", FirstProductPageLocators.basket_page_label_text, "My Basket Label")

    def verify_the_text_continue_shopping(self):
        """
        Method Name   : verify_the_text_continue_shopping
        Author        : Saptarshi
        Description   : Verifies the 'Continue Shopping' option is visible on the cart page
        Return Type   : None
        Parameters    : None
        """
        self.perform_action("VERIFY_VISIBLE", FirstProductPageLocators.continue_shopping_button, "Continue Shopping")
    ...
    def creativity_first_product_page_clutter_flow(self):
        """
        Method Name   : creativity_first_product_page_clutter_flow
        Author        : Saptarshi
        Description   : Clutter function for the creativity first product operations page
        Return Type   : None
        Parameters    : None
        """
